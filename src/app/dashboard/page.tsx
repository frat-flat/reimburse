        ...
        <div className="lg:col-span-2 space-y-4">
          {projects.length === 0 ? (
            <div className="bg-white border border-gray-200 rounded-xl p-8 text-center text-gray-500 shadow-sm">
              ...
              <p className="font-semibold text-lg text-gray-700">プロジェクトがありません</p>
              <p className="text-sm text-gray-500 mt-1">右側のフォームから新しく作成してください。</p>
            </div>
          ) : (
              ...
              {projects.map((project) => (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-bold text-gray-900 text-lg group-hover:text-indigo-600 transition-colors line-clamp-1 pr-6">
                      {project.name}
                    </h3>
                  ...
                  <div className="space-y-2 mt-auto pt-4 border-t border-gray-100 text-xs text-gray-500">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-indigo-600 font-medium inline-flex items-center gap-0.5 group-hover:translate-x-1 transition-transform">
