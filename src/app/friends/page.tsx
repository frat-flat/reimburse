  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-2 border-b border-gray-200">
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Mate管理</h1>
        ...
        <div className="md:col-span-2">
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm space-y-4 h-full">
            <div className="flex items-center gap-2 pb-3 border-b border-gray-100">
              ...
              <h2 className="text-base font-bold text-gray-900">Mate一覧 ({friends.length})</h2>
            </div>

            {friends.length === 0 ? (
              <div className="text-center py-20 text-gray-500 text-sm">
                <Users className="mx-auto h-12 w-12 text-gray-300 mb-3" />
                <p className="font-semibold text-gray-700">まだMateはいません</p>
                <p className="text-xs text-gray-400 mt-1">
                  左のフォームから相手のメールアドレスにMate申請を送ってください。
                </p>
              </div>
            ) : (
