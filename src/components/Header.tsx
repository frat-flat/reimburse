      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3 flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-3">
        ...
        <div className="hidden md:flex items-center gap-6">
          <nav className="flex items-center gap-4">
            ...
            <Link href="/friends" className="text-sm font-bold text-slate-600 hover:text-indigo-600 transition relative flex items-center gap-1.5">
            ...
            <Link href="/receipts" className="text-sm font-bold text-slate-600 hover:text-indigo-600 transition flex items-center gap-1.5">
              <Receipt className="h-4 w-4" strokeWidth={1.8} />
              <span>領収一覧</span>
            </Link>
            <Link href="/members" className="text-sm font-bold text-slate-600 hover:text-indigo-600 transition flex items-center gap-1.5">
              <UserCheck className="h-4 w-4" strokeWidth={1.8} />
              <span>ベースクルー登録</span>
            </Link>
            <Link href="/profile" className="text-sm font-bold text-slate-600 hover:text-indigo-600 transition flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <form action={actionLogout}>
              <button
                type="submit"
                className="text-sm font-medium text-rose-600 hover:text-rose-800 border border-rose-200 hover:bg-rose-50 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1 cursor-pointer"
              >
